...
function App() {
  ...
  return (
    <>
      ...
      <div className="container bg-slate-200 my-5 rounded-xl p-5 min-h-[80vh] w-1/2 mx-auto ">
        <div className="addTodos my-5 flex flex-col gap-5">
          <h1 className="font-bold text-center text-xl">iTask - Manage your task in one place</h1>
          ...
          <button
            ...
            className="bg-slate-800 disabled:bg-slate-700 hover:bg-slate-950 p-3 py-1 text-sm  font-bold text-white rounded-md"
          >
            Add
          </button>
        </div>
